...
Source0  : https://files.pythonhosted.org/packages/4a/b2/550fe500e49c464d73fabcb8cb04d47e4885d6ca4cfc1f5b0a125a95b19a/pyclipper-1.3.0.post6.tar.gz
...
%prep
%setup -q -n pyclipper-1.3.0.post6
cd %{_builddir}/pyclipper-1.3.0.post6
pushd ..
cp -a pyclipper-1.3.0.post6 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1729260783
